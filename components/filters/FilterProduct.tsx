...
export default function FilterProduct(props: FilterProductProps) {
  ...
  return (
    ...
    >
      ...
      <p className={"text-black text-xl h-20 text-center font-medium"}>{props.product.title}</p>
      ...
      <button
        className={
          "bg-main rounded-bl-full my-4 py-2 px-10 transition hover:scale-110 duration-300"
        }
